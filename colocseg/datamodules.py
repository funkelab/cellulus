...
# from datasets import (CoordinateDataset, TissueNetDataset, ZarrSegmentationDataset,
...
class AnchorDataModule(pl.LightningDataModule):
    ...
    def __init__(self, batch_size, dspath,
                 shape=(256, 256), output_shape=(240, 240), density=0.02,
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--positive_radius', nargs='*', default=(32, 32, 32))
...
class TissueNetDataModule(AnchorDataModule):
    ...
    def setup_datasets(self):
        ...
        print('self.dspath:',self.dspath+"/README.md")
