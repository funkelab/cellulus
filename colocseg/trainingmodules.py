...
class SSLTrainer(pl.LightningModule, BuildFromArgparse):
    ...
    def add_model_specific_args(parser):
        ...
        parser.add_argument('--coordinate_offset_after_valid_unet', nargs='*', type=int, default=(8, 8, 8, 8))
    ...
    def training_step(self, batch, batch_nb):
        ...
        print('emb_anchor.shape =',emb_anchor.shape)
        print('emb_ref.shape =',emb_ref.shape)
