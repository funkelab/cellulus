...
if __name__ == '__main__':
    ...
    parser = TissueNetDataModule.add_argparse_args(parser)
    parser = TissueNetDataModule.add_model_specific_args(parser)
    ...
    datamodule = TissueNetDataModule.from_argparse_args(args)
